...
// The startGame functiion is called when the start button is clicked
function startGame() {
    isWin = false;
    timerCount = 10;
...
//Tests if guessed letter is in word and renders it to screen.
...
// Attach event listener to documetn to listen for key event
