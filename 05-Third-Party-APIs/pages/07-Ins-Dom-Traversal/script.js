...
// Uncomment the following two lines to see th which elements are the children to the #top
...
//Uncoment the following line to add a list item to the list
$('#top').children().eq(4).append($('<li>Classmates</li>'));

// Uncomment the follwing line to style the list items
